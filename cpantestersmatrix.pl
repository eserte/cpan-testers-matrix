...
#
# $Id: cpantestersmatrix.pl,v 1.117 2010/01/03 10:15:55 eserte Exp $
# Author: Slaven Rezic
#
...
EOF
	...
	print <<EOF;
<li><a href="http://analysis.cpantesters.org/solved?distv=$dist-$dist_version">Reports analysis</a> (alpha alert!)
EOF
    }
    print <<EOF;
</ul>
